	...
	{		
		...
		fromObj.onclick = moveSingleElement;
		toObj.onclick = moveSingleElement;
		...
		subDiv.style.width = (Math.floor(totalWidth/2) - 105) + 'px';
		fromObj.style.width = (Math.floor(totalWidth/2) - 105) + 'px';
		...
		buttonDiv.style.width = '95px';
		buttonDiv.style.margin = '15px 30px';
        ...
        buttonAllRight.style.marginTop='22px';
         buttonAllRight.style.display = 'block';
        buttonAllRight.style.background = 'none';
        buttonAllRight.style.border = 'none';
         buttonAllRight.style.fontWeight='bold';
        ...
        buttonAllLeft.style.marginTop='3px';
          buttonAllLeft.style.fontWeight='bold';
		buttonAllLeft.value = '<<';
         buttonAllLeft.style.display = 'block';
        buttonAllLeft.style.background = 'none';
        buttonAllLeft.style.border = 'none';
		buttonAllLeft.onclick = moveAllElements;
		buttonDiv.appendChild(buttonAllLeft);
		
		var subDiv = document.createElement('DIV');
		subDiv.style.width = (Math.floor(totalWidth/2) - 105) + 'px';
		toObj.style.width = (Math.floor(totalWidth/2) - 105) + 'px';
        subDiv.style.float = 'left';
        subDiv.style.marginLeft = '18px';
		var label = document.createElement('SPAN');
        label.style.margin = '33px';
